  ...
  return (
    <section id="about" className={className}>
      ...
      <p className={styles.text}>
        ...
        <br />
        独学でプログラミングを学習し、2023年3月から未経験でWebデザイナーのアルバイトに取り組んでおり、AdobeXDで1からデザインを組みHTMLやCSS、JavaScriptでコーディングをしています。
        <br />
        私の強みは、能動的に行動できることです。
        <br />
        アルバイト先は少人数で自律的に業務を進める事が歓迎されていたため、全て自分で調べ解決するよう常に努力しました。
        <br />
